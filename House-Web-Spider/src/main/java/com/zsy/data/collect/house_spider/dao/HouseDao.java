package com.zsy.data.collect.house_spider.dao;

import com.zsy.data.collect.house_spider.model.House;
...
public class HouseDao {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/house?" + "user=root&password=root&useUnicode=true&characterEncoding=UTF8";
