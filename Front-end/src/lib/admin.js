...
layui.define('view', function(exports) {
    ...
    admin = {
      ...
      theme: function(options) {
        var theme = setter.theme,
          local = layui.sessionData(setter.tableName),
          ...
          styleText = laytpl(
            [
              ...
              '.layui-btn {background-color:{{d.color || d.color.main}} !important;}',
  ...
  var events = (admin.events = {
    ...
    note: function(othis) {
      var mobile = admin.screen() < 2,
        note = layui.sessionData(setter.tableName).note
  ...
  //窗口resize事件
  var resizeSystem = (layui.sessionData.resizeSystem = function() {
  ...
  $win.on('resize', layui.sessionData.resizeSystem)
