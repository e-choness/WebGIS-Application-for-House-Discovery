layui.define(['arcgis'], function(exports) {
  ...
  function render_layer(container, callback) {
    const url_RiverNetwork = "json/ChaohuShijidadao/Shijidadao_RiverNetwork_2D_v01.json";
    const url_RiverCrossSections = "json/ChaohuShijidadao/Shijidadao_RiverCrossSections_v01.json";
    const url_RiverWeir_2D = "";
    const url_RiverDischarge = "json/ChaohuShijidadao/Shijidadao_RiverDischarge_v01.json";
    
    const url_RainPipeline_2D = "json/ChaohuShijidadao/Shijidadao_RainPipeline_2D_v01.json";
    const url_RainManhole_2D = "json/ChaohuShijidadao/Shijidadao_RainManhole_2D_v01.json";
    const url_RainStorages = "";
    const url_RainWeirs_2D = "";
    const url_RainPumpSump = "json/ChaohuShijidadao/Shijidadao_RainPump_Sump_v01.json";
    const url_RainPumpStation = "json/ChaohuShijidadao/Shijidadao_RainPump_Station_v01.json";
    const url_RainPumpDischarge = "json/ChaohuShijidadao/Shijidadao_RainPump_Discharge_v01.json";

    const url_SewagePipeline_2D = "json/ChaohuShijidadao/Shijidadao_SewagePipeline_2D_v01.json";
    const url_SewageManhole_2D = "json/ChaohuShijidadao/Shijidadao_SewageManhole_2D_v01.json";
    const url_SewagePumpSump = "json/ChaohuShijidadao/Shijidadao_SewagePump_Sump_v01.json";
    const url_SewagePumpStation = "json/ChaohuShijidadao/Shijidadao_SewagePump_Station_v01.json";
    const url_SewagePumpDischarge = "json/ChaohuShijidadao/Shijidadao_SewagePump_Discharge_v01.json";

    const url_CSOPipeline_2D = "json/ChaohuShijidadao/Shijidadao_CSOPipeline_2D_v01.json";
    const url_CSOManhole_2D = "json/ChaohuShijidadao/Shijidadao_CSOManhole_2D_v01.json";
    const url_Outfalls = "json/ChaohuShijidadao/Shijidadao_Outfalls_v01.json";

    const url_RainSubCatchment_1Whole = "json/ChaohuShijidadao/Shijidadao_RainSubCatchment_1Whole_v01.json";
    const url_RainSubCatchment_2Discharge = "";
    const url_RainSubCatchment_3Block = "";
    const url_RainSubCatchment_4Plot = "json/ChaohuShijidadao/Shijidadao_RainSubCatchment_4Plot_v01.json";
    const url_RainSubCatchment_5Cell = "json/ChaohuShijidadao/Shijidadao_RainSubCatchment_5Cell_v01.json";

    const url_SewageSubCatchment_1Whole = "";
    const url_SewageSubCatchment_2Discharge = "";
    const url_SewageSubCatchment_3Block = "";
    const url_SewageSubCatchment_4Plot = "json/ChaohuShijidadao/Shijidadao_SewageSubCatchment_4Plot_v01.json";
    const url_SewageSubCatchment_5Cell = "";

    const url_Monitoring_Weather = "json/ChaohuShijidadao/Shijidadao_Monitor_Weather_v01.json";

    const url_Monitoring_Water = "json/ChaohuShijidadao/Shijidadao_Monitor_Water_v01.json";

    const url_Monitoring_RiverDischarge = "";
    const url_Monitoring_RiverCrossSections = "json/ChaohuShijidadao/Shijidadao_Monitor_River_CrossSections_v01.json";
    
    const url_Monitoring_Rain_1Whole = "json/ChaohuShijidadao/Shijidadao_Monitor_Rain_1Whole_v01.json";
    const url_Monitoring_Rain_2Discharge = "json/ChaohuShijidadao/Shijidadao_Monitor_Rain_2Discharge_v01.json";
    const url_Monitoring_Rain_3Block = "json/ChaohuShijidadao/Shijidadao_Monitor_Rain_3Block_v01.json";
    const url_Monitoring_Rain_4Plot = "json/ChaohuShijidadao/Shijidadao_Monitor_Rain_4Plot_v01.json";
    const url_Monitoring_Rain_5Cell = "";

    const url_Monitoring_Sewage_1Whole = "json/ChaohuShijidadao/Shijidadao_Monitor_Sewage_1Whole_v01.json";
    const url_Monitoring_Sewage_2Discharge = "json/ChaohuShijidadao/Shijidadao_Monitor_Sewage_2Discharge_v01.json";
    const url_Monitoring_Sewage_3Block = "json/ChaohuShijidadao/Shijidadao_Monitor_Sewage_3Block_v01.json";
    const url_Monitoring_Sewage_4Plot = "json/ChaohuShijidadao/Shijidadao_Monitor_Sewage_4Plot_v01.json";
    ...
    console.log('shijidadao res: ', map, view)
    ...
    setTimeout(()=>{
      RainSubCatchmentZoneGroupLayer.add(geojsonLayer_RainSubCatchment_5Cell)
    }, 10000)
