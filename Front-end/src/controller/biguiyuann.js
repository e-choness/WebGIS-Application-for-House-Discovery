layui.define(['arcgis'], function(exports) {
  ...
  function render_layer(container, callback) {
    const url_RiverNetwork = "json/BiguiyuanNan/BiguiyuanNan_RiverNetwork_2D_v01.json";
    const url_RiverCrossSections = "json/BiguiyuanNan/BiguiyuanNan_RiverCrossSections_v01.json";
    const url_RiverWeir_2D = "";
    const url_RiverDischarge = "json/BiguiyuanNan/BiguiyuanNan_RiverDischarge_v01.json";
    
    const url_RainPipeline_2D = "json/BiguiyuanNan/BiguiyuanNan_RainPipeline_2D_v01.json";
    const url_RainManhole_2D = "json/BiguiyuanNan/BiguiyuanNan_RainManhole_2D_v01.json";
    ...
    const url_SewagePipeline_2D = "json/BiguiyuanNan/BiguiyuanNan_SewagePipeline_2D_v01.json";
    const url_SewageManhole_2D = "json/BiguiyuanNan/BiguiyuanNan_SewageManhole_2D_v01.json";
    const url_SewagePumpSump = "json/BiguiyuanNan/BiguiyuanNan_SewagePump_Sump_v01.json";
    const url_SewagePumpStation = "json/BiguiyuanNan/BiguiyuanNan_SewagePump_Station_v01.json";
    const url_SewagePumpDischarge = "json/BiguiyuanNan/BiguiyuanNan_SewagePump_Discharge_v01.json";

    const url_CSOPipeline_2D = "";
    const url_CSOManhole_2D = "";
    const url_Outfalls = "";

    const url_RainSubCatchment_1Whole = "json/BiguiyuanNan/BiguiyuanNan_RainSubCatchment_1Whole_v01.json";
    const url_RainSubCatchment_2Discharge = "json/BiguiyuanNan/BiguiyuanNan_RainSubCatchment_2Discharge_v01.json";
    const url_RainSubCatchment_3Block = "json/BiguiyuanNan/BiguiyuanNan_RainSubCatchment_3Block_v01.json";
    const url_RainSubCatchment_4Plot = "json/BiguiyuanNan/BiguiyuanNan_RainSubCatchment_4Plot_v01.json";
    const url_RainSubCatchment_5Cell = "json/BiguiyuanNan/BiguiyuanNan_RainSubCatchment_5Cell_v01.json";

    const url_SewageSubCatchment_1Whole = "";
    const url_SewageSubCatchment_2Discharge = "";
    const url_SewageSubCatchment_3Block = "";
    const url_SewageSubCatchment_4Plot = "json/BiguiyuanNan/BiguiyuanNan_SewageSubCatchment_4Plot_v01.json";
    const url_SewageSubCatchment_5Cell = "";

    const url_Monitoring_Weather = "json/BiguiyuanNan/BiguiyuanNan_Monitor_Weather_v01.json";

    const url_Monitoring_Water = "";

    const url_Monitoring_RiverDischarge = "";
    const url_Monitoring_RiverCrossSections = "json/BiguiyuanNan/BiguiyuanNan_Monitor_River_CrossSections_v01.json";
    
    const url_Monitoring_Rain_1Whole = "";
    const url_Monitoring_Rain_2Discharge = "json/BiguiyuanNan/BiguiyuanNan_Monitor_Rain_2Discharge_v01.json";
    const url_Monitoring_Rain_3Block = "";
    const url_Monitoring_Rain_4Plot = "json/BiguiyuanNan/BiguiyuanNan_Monitor_Rain_4Plot_v01.json";
    const url_Monitoring_Rain_5Cell = "";

    const url_Monitoring_Sewage_1Whole = "json/BiguiyuanNan/BiguiyuanNan_Monitor_Sewage_1Whole_v01.json";
    const url_Monitoring_Sewage_2Discharge = "json/BiguiyuanNan/BiguiyuanNan_Monitor_Sewage_2Discharge_v01.json";
    const url_Monitoring_Sewage_3Block = "json/BiguiyuanNan/BiguiyuanNan_Monitor_Sewage_3Block_v01.json";
    const url_Monitoring_Sewage_4Plot = "json/BiguiyuanNan/BiguiyuanNan_Monitor_Sewage_4Plot_v01.json";
